...
def border_retriever(z):
        global session,zone,border_gw,kind,target,br_delay
...
zone = 1
#fast_links = []
fast_links = [(to_dpid(2),to_dpid(4)),(to_dpid(4),to_dpid(2)),(to_dpid(4),to_dpid(3)),(to_dpid(3),to_dpid(4)),(to_dpid(4),to_dpid(1)),(to_dpid(1),to_dpid(4)),("00:00:00:00:00:01",to_dpid(1)),(to_dpid(1),"00:00:00:00:00:01"),("00:00:00:00:00:02",to_dpid(2)),(to_dpid(2),"00:00:00:00:00:01")]
...
class Controllerz1(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        if flag == 0:
            ...
            net[self.to_dpid(4)]['gateway2']['weight'] = 1000
            net['gateway2'][self.to_dpid(4)]['weight'] = 1000
